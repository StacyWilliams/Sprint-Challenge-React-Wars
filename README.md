...
- [x] What is React JS and what problems does it try and solve? Support your answer with concepts introduced in class and from your personal research on the web.
    ...
    THe main problem sovled by React is the development of large applications that have temporal data changes.

- [x] What does it mean to _think_ in react?

      To think in components and component hierachies
...
- [x] Describe props.
      ...
      Properties that are passed on to other components
